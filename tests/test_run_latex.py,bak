...
def test_run_latex_custom_tex_args():
    res = run_latex(
        EXAMPLE_RECTANGLE_TIKZ,
        rasterize=False,
        tex_args="--enable-write18 --extra-mem-top=10000000 --extra-mem-bot=10000000",
    )
    expected_res = RENDERED_RECTANGLE_SVG
